...
public final void init()
{
   ...
   // Give ImageGetter ability to load Images
   //ImageGetter.setApplet(this);
...
public abstract void keyPressed(int code, boolean shiftdown);
